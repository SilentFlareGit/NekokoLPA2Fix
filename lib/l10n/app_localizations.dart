...
abstract class AppLocalizations {
  ...
  /// No description provided for @omapiRebootRequiredTitle.
  ///
  /// In en, this message translates to:
  /// **'Restart required'**
  String get omapiRebootRequiredTitle;

  /// No description provided for @omapiRebootRequiredMessage.
  ///
  /// In en, this message translates to:
  /// **'The SIM/eSIM channel became invalid while switching profiles. The operation may already have taken effect. Restart the device, reopen the app, and refresh profile status before retrying.'**
  String get omapiRebootRequiredMessage;
}
