...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get omapiRebootRequiredTitle => '需要重启设备';

  @override
  String get omapiRebootRequiredMessage =>
      'SIM/eSIM 通道在切换过程中失效。操作可能已经生效。请先重启设备，重新打开应用并刷新 Profile 状态后，再决定是否重试。';
}
...
class AppLocalizationsZhTw extends AppLocalizationsZh {
  ...
  @override
  String get omapiRebootRequiredTitle => '需要重新啟動裝置';

  @override
  String get omapiRebootRequiredMessage =>
      'SIM/eSIM 通道在切換過程中失效。操作可能已經生效。請先重新啟動裝置，重新開啟應用程式並重新整理 Profile 狀態後，再決定是否重試。';
}
